...
- This is intentionally a subset, not a full mirror of the original working repo.
- Theorem bundles are organized by request ID folder names under `data/theorems/`.
